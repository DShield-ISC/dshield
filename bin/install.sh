...
# twisted v15.2.1 isn't working (problems with SSH key)

for PKGVER in twisted,16.6.0 cryptography,0 configparser,0 pyopenssl,0 gmpy2,0 pyparsing,0 packaging,0 appdirs,0 pyasn1-modules,0 attrs,0 service-identity,0 pycrypto,0 python-dateutil,0 tftpy,0 ; do
...
***
***    DShield Honeypot - Web Admin on port 8000
***
